export default function WorksSection() {
  const works = [
    {
      subtitle: "Instalacao Residencial",
      video: "/videos/trabalho-action-1.mp4",
    },
    { subtitle: "Projeto Corporativo", video: "/videos/trabalho-new.mp4" },
    {
      subtitle: "Automacao de Elite",
      video: "/videos/trabalho-action-3.mp4",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="mb-16 reveal text-center">
          <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter italic text-foreground">
            ViniDigital <span className="text-primary">em Acao.</span>
          </h2>
