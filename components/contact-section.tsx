...
export default function ContactSection() {
  const handleContact = () => {
    window.open(
      "https://wa.me/5581988845760?text=Vim%20do%20seu%20site%20e%20quero%20contratar%20seus%20servi%C3%A7os!",
      "_blank"
    );
  };
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mt-20 reveal flex flex-col items-center">
          <img
            ...
            alt="ViniDigital Emblem"
            className="h-32 w-32 md:h-48 md:w-48 object-contain rounded-full border-2 border-primary/50 shadow-2xl"
          />
          <p className="text-primary/30 text-[9px] font-black tracking-[0.4em] uppercase italic mt-4">
            Segue em frente ate dar certo
          </p>
        </div>
      </div>
    </section>
